...
if (isset ($_SESSION['user_id'])) {
    ...
    <head>
        ...
        <title>
            المجتمع المدرسي الطلابي | <?= $_SESSION['school_name'] ?>
        </title>
    ...
    <div class="container">
        ...
        <!-- Main -->
        <main class="main">
            <h1>المجتمع الطلابي - مدرسة <?= $_SESSION['school_name'] ?></h1>
            <?php if ($_SESSION['user_role'] !== 'teacher') { ?>
                <section class="evaluation-section">
                    <div class="evaluation-header">
                        <h2><i class="fa-solid fa-pen-to-square"></i> إنشاء منشور</h2>
                    </div>
                    <form accept-charset="UTF-8" action="includes/create_post.inc.php" method="post" enctype="multipart/form-data">
                        <?php
                        print_saved_errors();
                        ?>
                        <div class="post-form">
