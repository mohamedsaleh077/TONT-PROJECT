...
if ((isset($_FILES['media']) && $_FILES['media']['error'] !== UPLOAD_ERR_NO_FILE)) {
    ...
    if (!$error->getErrors()) {
        try {
            ...
            $upload = new UploadFile($_FILES['media'], 'post_media_', '/community/uploads/');
